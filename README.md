...
A simple, easy to customize entity component system framework.
...
mkdir build
cd build
cmake .. # -DBUILD_EXAMPLES=true to build example binaries.
make
```

## Usage

Link library `libecsx` in with your project, and include `ECSX/ECSX.hpp`
...
See `examples/*` for any more examples I may add in the future.

## Docs

You can find the docs [here.](http://sarahkittyy.github.io/ECSX)

## Todo

* Add examples for world inheritance.